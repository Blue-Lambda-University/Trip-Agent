...
from helper.aws_helper.credentials import get_credentials
...
# Load AWS credentials from env vars or IAM role
...
class S3Handler:
    ...
    def upload_csv(self, bucket_name, file_path):

        # Change these
        s3_key = "uploads/mydata.csv"  # Path inside the bucket
    ...
    def upload_file(self, bucket_name: str, filename: str, file: io.BytesIO, folder: str = ""):
        ...
        """
        try:
            self.client.upload_fileobj(file.file, S3_BUCKET_NAME, f"uploads/{file.filename}")
...
def main():
    ...
    s3_handler.upload_csv("bluelambdalambda", "/Users/bluelambdauniversity/PycharmProjects/UNIVERSITY/Trip-Agent/helper/preprocessing/data.csv")
